...
set(MSG_I_FLAGS "-Ipath_planning:/home/chen/control_ws/src/path_planning/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/chen/control_ws/src/path_planning/msg/velocity.msg" NAME_WE)
add_custom_target(_path_planning_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "path_planning" "/home/chen/control_ws/src/path_planning/msg/velocity.msg" ""
)
...
_generate_msg_cpp(path_planning
  "/home/chen/control_ws/src/path_planning/msg/velocity.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/path_planning)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/path_planning\")")
  # install generated code
  install(
